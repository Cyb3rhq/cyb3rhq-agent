...
Please submit your findings as [security advisories](https://github.com/cyb3rhq/cyb3rhq/security/advisories) under the "Security" tab in the relevant GitHub repository. Alternatively, you may send the details of your findings to security@wazuh.com.
