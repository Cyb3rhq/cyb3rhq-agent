...
brief: The 'cyb3rhq-logcollector' daemon monitors configured files and commands for new log messages.
       ...
       the 'out_format' tag and the Cyb3rhq API returns the same values for the configured
...
config_path = Path(CONFIGURATIONS_PATH, 'cyb3rhq_basic_configuration_out_format.yaml')
...
def test_configuration_out_format(test_configuration, test_metadata, set_cyb3rhq_configuration, configure_local_internal_options, daemons_handler_module, stop_logcollector):
    '''
    description: Check if the 'cyb3rhq-logcollector' daemon detects invalid settings for the 'out_format' tag.
