...
from cyb3rhq_testing.modules.monitord import configuration as monitord_config
...
CYB3RHQ_MODULES_DEBUG = 'cyb3rhq_modules.debug'
...
local_internal_options = {CYB3RHQ_MODULES_DEBUG: '2',
