...
#include "../../cyb3rhq_modules/wm_task_general.h"
#include "../../cyb3rhq_modules/wmodules.h"
#include "../../cyb3rhq_modules/agent_upgrade/wm_agent_upgrade.h"
#include "../../cyb3rhq_modules/agent_upgrade/agent/wm_agent_upgrade_agent.h"
...
void test_unsign_invalid_source_incomming(void **state) {
    ...
    will_return(__wrap_w_ref_parent_folder, 1);
    expect_string(__wrap__mterror, tag, "cyb3rhq-modulesd:agent-upgrade");
...
void test_wm_agent_upgrade_com_open_unsopported_mode(void **state) {
    ...
    expect_string(__wrap__mtwarn, tag, "cyb3rhq-modulesd:agent-upgrade");
...
void test_wm_agent_upgrade_com_clear_result_failed(void **state) {
    ...
    expect_string(__wrap__mtdebug1, tag, "cyb3rhq-modulesd:agent-upgrade");
    #ifndef TEST_WINAGENT
