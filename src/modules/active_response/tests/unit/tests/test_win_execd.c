...
#include "../wrappers/cyb3rhq/os_execd/exec_wrappers.h"
#include "../wrappers/cyb3rhq/shared/debug_op_wrappers.h"
#include "../wrappers/cyb3rhq/shared/exec_op_wrappers.h"
...
static int test_setup_file_timeout(void **state) {
    ...
    os_strdup("restart-cyb3rhq10", timeout_entry->command[0]);
    timeout_entry->command[1] = NULL;
    os_strdup("restart-cyb3rhq-10.0.0.1-root", timeout_entry->rkey);
...
static void test_WinExecdRun_ok(void **state) {
    ...
    expect_string(__wrap_GetCommandbyName, name, "restart-cyb3rhq0");
    will_return(__wrap_GetCommandbyName, timeout);
    will_return(__wrap_GetCommandbyName, "restart-cyb3rhq");

    expect_string(__wrap__mdebug1, formatted_msg, "Executing command 'restart-cyb3rhq {"
                                                                                        "\"version\":\"1\","
                                                                                        "\"origin\":{"
                                                                                            "\"name\":\"node01\","
...
static void test_WinExecdRun_timeout_not_repeated(void **state) {
    ...
    expect_string(__wrap_GetCommandbyName, name, "restart-cyb3rhq10");
    will_return(__wrap_GetCommandbyName, timeout);
    will_return(__wrap_GetCommandbyName, "restart-cyb3rhq");
    ...
    expect_string(__wrap__mdebug1, formatted_msg, "Adding command 'restart-cyb3rhq {"
                                                                                    "\"version\":\"1\","
                                                                                    "\"origin\":{"
                                                                                        "\"name\":\"node01\","
                                                                                        "\"module\":\"cyb3rhq-execd\""
...
static void test_WinExecdRun_fgets_err(void **state) {
    ...
    expect_string(__wrap__mdebug1, formatted_msg, "Active response won't be added to timeout list. Message not received with alert keys from script 'restart-cyb3rhq'");
...
static void test_WinExecdRun_get_command_err(void **state) {
    ...
    expect_string(__wrap__merror, formatted_msg, "(1311): Invalid command name 'restart-cyb3rhq0' provided.");
