...
from cyb3rhq_testing.modules.fim.patterns import REALTIME_WHODATA_ENGINE_STARTED
...
def test_whodata_ambiguous_thread(test_configuration, test_metadata, set_cyb3rhq_configuration, configure_local_internal_options,
