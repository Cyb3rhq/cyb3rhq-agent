...
from cyb3rhq_testing.modules.fim.patterns import FILE_LIMIT_DISABLED
...
def test_limit_disabled(test_configuration, test_metadata, set_cyb3rhq_configuration, truncate_monitored_files,
                        configure_local_internal_options, folder_to_monitor, daemons_handler, start_monitoring):
    '''
    description: Check if the 'cyb3rhq-syscheckd' daemon detects that the 'file_limit' feature of FIM is disabled.
    ...
    cyb3rhq_log_monitor.start(generate_callback(FILE_LIMIT_DISABLED))
