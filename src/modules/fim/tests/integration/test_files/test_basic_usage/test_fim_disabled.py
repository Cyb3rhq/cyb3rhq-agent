...
from cyb3rhq_testing.modules.fim.patterns import SENDING_FIM_EVENT
...
def test_fim_disabled(test_configuration, test_metadata, set_cyb3rhq_configuration, truncate_monitored_files,
    ...
    cyb3rhq_log_monitor.start(generate_callback(SENDING_FIM_EVENT))
