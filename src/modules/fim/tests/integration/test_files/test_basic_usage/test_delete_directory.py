...
from cyb3rhq_testing.modules.fim.patterns import EVENT_TYPE_DELETED, EVENT_TYPE_MODIFIED
...
def test_delete_dir(test_configuration, test_metadata, set_cyb3rhq_configuration, configure_local_internal_options,
