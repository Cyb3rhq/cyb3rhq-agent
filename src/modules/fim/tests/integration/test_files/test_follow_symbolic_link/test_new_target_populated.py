...
from cyb3rhq_testing.modules.fim.patterns import EVENT_TYPE_ADDED, EVENT_TYPE_MODIFIED, LINKS_SCAN_FINALIZED
...
def test_new_target_populated(test_configuration, test_metadata, set_cyb3rhq_configuration, truncate_monitored_files,
    ...
    cyb3rhq_log_monitor.start(generate_callback(EVENT_TYPE_ADDED))
