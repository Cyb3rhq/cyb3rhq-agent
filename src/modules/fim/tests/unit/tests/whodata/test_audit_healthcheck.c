...
#include "wrappers/cyb3rhq/shared/atomic_wrappers.h"
#include "wrappers/cyb3rhq/shared/time_op_wrappers.h"
#include "wrappers/cyb3rhq/shared/pthreads_op_wrappers.h"
...
void prepare_post_audit_healthcheck_thread() {
    ...
    expect_string(__wrap_audit_delete_rule, key, "cyb3rhq_hc");
