...
@patch('gcloud.Cyb3rhqGCloudSubscriber')
...
@patch('pubsub.subscriber.Cyb3rhqGCloudSubscriber.check_permissions')
@patch('pubsub.subscriber.Cyb3rhqGCloudSubscriber.process_messages')
